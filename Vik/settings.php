       ...
       <!-- ===== Header Start ===== -->
        ...
        <main>
          <div class="main-content">
              ...
              <form class="grid grid-cols-5 gap-8" action="partials/staff/updatestaff.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo htmlspecialchars($staff['id']); ?>">
                
                <!-- Left Column - Personal Information -->
                <div class="col-span-5 xl:col-span-3">
                  <div class="personal-info-section rounded-sm border border-stroke bg-white shadow-default">
                    <div class="personal-info-header border-b border-stroke px-7 py-4 dark:bg-boxdark dark:border-transparent">
    ...
    <span class="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 fill-current">
      ...
      >
        ...
        />
                      ...
                      <div class="mb-4 flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div class="flex gap-2.5">
                            ...
                            <button for="photo_upload" class="text-sm hover:text-primary cursor-pointer">Update</bu>
                          </div>
                        </div>
                      </div>
                ...
                <!-- Single set of form buttons at the bottom -->
                <div class="col-span-5 flex justify-end gap-4 mt-6">
                  <button type="button" class="button-cancel dark:border-strokedark dark:text-white" onclick="window.location.reload();">
                    Cancel
                  </button>
                  <button type="submit" class="button-save dark:border-strokedark dark:text-white" name="update_profile">
                    Save Changes
                  </button>
                </div>
              </form>
